...
contract Redress is InternalModule, RedressInterface {
    ...
    function WithdrawRedress() external returns (uint256) {
        ...
        _EInc.MoveToken( address(_EInc), msg.sender, amount );
    ...
    function AddRedress( address who, uint256 amount ) external APIMethod {
    ...
    function SetRedressProp100(uint256 p) external OwnerOnly {
        _withdrawProp = p;
    }
}
