...
contract Recommend is RecommendInterface, InternalModule {
    ...
    function MarkValid( address _addr, uint256 _evalue ) external APIMethod {
    ...
    function BindEx( address _owner, address _recommer, bytes6 shortCode ) external APIMethod {
